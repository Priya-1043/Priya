...
Input Params: NILL
Return Type: void
Description: To choose categories of products
**/
void menu()
{
    int choice;
...
Input Params: EA, int 
Return Type: void
Description: For sorting Electronic Appliances by latest arrival criteria
**/
...
Input Params: EA, int 
Return Type: void
Description: For sorting Electronic Appliances by rating criteria
**/
...
Input Params: EA, int 
Return Type: void
Description: For sorting Clothing and Accessories by latest arrival criteria 
**/
...
Input Params: CA, int 
Return Type: void
Description: For sorting Clothing and Accessories by rating criteria
**/
...
Input Params: CA, int 
Return Type: void
Description: For sorting Furniture by latest arrival criteria 
**/
...
Input Params: FN, int 
Return Type: void
Description: For sorting Furniture by rating criteria
**/
...
Input Params: FN, int 
Return Type: void
Description: For sorting Sports by latest arrival criteria 
**/
...
Input Params: SF, int 
Return Type: void
Description: For sorting Sports by rating criteria 
**/
...
Input Params: SF, int 
Return Type: void
Description: For sorting Healthcare and Cosmetics by latest arrival criteria 
**/
...
Input Params: HC, int 
Return Type: void
Description: For sorting Healthcare and Cosmetics by rating criteria
**/
...
Input Params: HC, int 
Return Type: void
Description: For sorting Grocery by latest arrival criteria
**/
...
Input Params: GR, int 
Return Type: void
Description: For sorting Grocery by rating criteria 
**/
...
Input Params: NILL
Return Type: void
Description: For displaying products in the cart 
**/
void displayCart()
{
    int choice;
...
Return Type: void
Description: For adding products to cart 
**/
...
Input Params: NILL
Return Type: void
Description: For applying discounts 
**/
void discount()
{
    CART *temp=start;
...
Input Params: NILL
Return Type: void
Description: For finalizing the order 
**/
void order()
{
    CART *ptr;
